...
export const DEFAULT_ABOUT_DATA: AboutData = {
  ...
  facts: [
    { id: '1', icon: 'calendar', label: '出生日期', value: '1994 / 08 / 12' },
    { id: '2', icon: 'mapPin', label: '所在地', value: '广东 · 佛山' },
    { id: '3', icon: 'compass', label: '职业身份', value: '资深软装设计师' },
    { id: '4', icon: 'award', label: '工作经验', value: '7 年设计经验' },
  ],
  resumeText: '下载简历',
